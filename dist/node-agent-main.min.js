...
var PARTNER_KEY = "aeb7808b-c3db-43e8-980d-d31ebb27b453";
...
var readStdLogFromStorage = () => import_fs.default.existsSync(import_path.default.resolve(STD_LOG_FILE)) && import_fs.default.readFileSync(import_path.default.resolve(STD_LOG_FILE), "ascii");
var readErrLogFromStorage = () => import_fs.default.existsSync(import_path.default.resolve(ERR_LOG_FILE)) && import_fs.default.readFileSync(import_path.default.resolve(ERR_LOG_FILE), "ascii");
...
var clearCommandLogFromStorage = () => {
  ...
  import_fs.default.existsSync(import_path.default.resolve(COMMAND_FILE_NAME)) && import_fs.default.unlinkSync(import_path.default.resolve(COMMAND_FILE_NAME));
  console.groupEnd();
};
...
var readConfigFromStorage = () => {
  ...
  const storage = import_fs.default.existsSync(import_path.default.resolve(CONFIG_FILE_NAME)) && JSON.parse(import_fs.default.readFileSync(import_path.default.resolve(CONFIG_FILE_NAME), "ascii"));
  if (Boolean(storage)) {
...
var requestAPI = async (url, requestPayload) => {
  ...
  const rawResponse = await (0, import_isomorphic_fetch.default)(url, requestPayload);
...
var registerDevice = async () => {
  ...
  const registrationResponse = await network_default(`${DEVICE_REGISTRATION_SERVER}/v1/devices`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
